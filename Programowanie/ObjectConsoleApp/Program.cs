...
Console.WriteLine($"firstPointClass ma ({firstPointStruct.x}, {firstPointStruct.y}) ");

secondPointClass.x = 30;
    Console.WriteLine($"firstPointClass ma ({firstPointStruct.x}, {firstPointStruct.y}) ");
Console.WriteLine($"firstPointClass ma ({secondPointStruct.x}, {secondPointStruct.y}) ");
